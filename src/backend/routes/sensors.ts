  ...
  const results = await db
    .prepare(
      ...
      SELECT
        ...
        AVG((temperature * 9.0 / 5.0) + 32.0) AS temperature,
        AVG(COALESCE(temperature_c, temperature)) AS temperatureC,
        AVG(COALESCE(temperature_f, (temperature * 9.0 / 5.0) + 32.0)) AS temperatureF,
